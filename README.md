...
|---|---|---|
| Easy | 0.5 – 0.8 | Loyal tenant is forgiving |
| Medium | 0.3 – 0.6 | Must avoid over-pricing |
| Hard | 0.2 – 0.5 | Mandatory maintenance critical |

_Scores depend on the LLM model used. GPT-4o achieves the upper ranges._
